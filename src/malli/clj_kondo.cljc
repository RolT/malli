...
(defmethod accept :and [_ _ children _] (first children)) ;; arbitrarily choosing first, could be improved using type hierarchy and choosing most specific type
(defmethod accept :andn [_ _ children _] (last (first children)))
